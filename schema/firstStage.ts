...
export const firstStage = z.object({
  ...
  department: z.string().min(1, "Enter your department please"),
  location: z.string().min(1, "Enter your location please"),
  startDate: z
    .string()
    .min(1, "Date is required")
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Invalid date format (YYYY-MM-DD)"),
  currentAddress: z.string().min(1, "Enter your current address please"),
  permanentAddress: z.string().min(1, "Enter your permanent address please"),
  phoneNo: z
    .string()
